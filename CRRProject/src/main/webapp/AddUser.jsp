...
<body>
    ...
    <div class="body">
    	<form method="get" action="AddAction.jsp">
			Name : <input type="text" name="username" class="name" required><br><br>
			Password : <input type="password" name="password" class="password" required><br><br>
			Police Id : <input type="text" name="policeId" class="text" pattern="\d{6}" required><br><br>
			Email : <input type="email" name="email" class="email" required><br><br>
			State : &nbsp;
			...
			<input type="submit" class="but" value="Add">
		</form>
    </div>
</div>
