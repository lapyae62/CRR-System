              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="detail-box">
                    ...
                    <p>
                      This website will help you to report quickly about crimes and show the 
                      static criminal records, QUICK CONTACT US!
                    </p>
                    <div class="btn-box">
                      <a href="contact.jsp" class="btn-1"> Report a crime </a>
                      <a href="about.jsp" class="btn-2">Learn more</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 px-0">
          <div class="detail-box">
            ...
            <p>
              If we have to tell about us in brief, we decided to choose this system to develop because we think our country lack
              swift reports on crimes and we thought that if we could provide a way for that, may be the crimes would go down for just a bit.
            </p>
            <div class="btn-box">
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                We provide the users not only to report crimes but also to report criminals in case some of them is likely to try and commit
                another crimes and may be we can help the authorities in keeping an eye on them and to keep track of their location maybe.
              </p>
        ...
        <div class="col-md-4">
          ...
          c10.095-0.01,18.276-8.191,18.286-18.286V283.429C475.419,273.334,467.238,265.153,457.143,265.143z" />
            ...
            <div class="detail-box">
              ...
              <p>
                Want to know what crimes are committed the most in your region? How would you want to know the info? Whether it's in terms of Crime type or Crime Rate, We 
                are trying to provide this info through the reports admitted to us by the various users.
              </p>
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
              Are you a policeman? Well, buddy! We are trying to keep the crimes going higher and in short of professionals like yourself.
              Get Signed-up and become a second-end user in our system. Let's try making the world a little peaceful together, you and us.
              </p>
              ...
              <div class="contact_form-container">
                <div>
                  ...
                  <div>
                    ...
                    <select name="Region" style="width:220px; height:35px; padding-left:10px; border-radius:10px;" required >
                  ...
                  <div>
                    ...
                    <select name="CrimeType" style="height:35px; width:220px; padding-left:10px; border-radius:10px;" required>
                  ...
                  <br>
                    <textarea name="description" rows="4" cols="50" style="border-radius:10px; padding:10px 5px 5px 10px;" placeholder="Describe about the incident in here!(max-900 characters)"></textarea>
